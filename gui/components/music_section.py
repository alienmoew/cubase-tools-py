...
class MusicSection(BaseComponent):
    ...
    def _create_volume_controls(self, parent):
        ...
        volume_container = CTK.CTkFrame(parent, fg_color="#1E1E1E", corner_radius=3, border_width=1, border_color="#9C27B0")
        # GIẢM PADDING
        volume_container.pack(fill="x", pady=1, padx=1)
        ...
        self.mute_toggle_btn.pack(side="left", padx=1)
        ...
        self.volume_value_label.pack(side="left", padx=(5, 0))
    ...
    def _create_tone_controls(self, parent):
        ...
        tone_nhac_container = CTK.CTkFrame(parent, fg_color="#1E1E1E", corner_radius=3, border_width=1, border_color="#2196F3")
        # GIẢM PADDING
        tone_nhac_container.pack(fill="x", pady=1, padx=1)
        ...
        btn_lower.pack(side="left", padx=1)
        ...
        btn_normal.pack(side="left", padx=1)
        ...
        btn_raise.pack(side="left", padx=1)
        ...
        self.soundshifter_value_label.pack(side="left", padx=(5, 0))
        
    def _create_transpose_controls(self, parent):
        """Tạo transpose controls với màu tím."""
        transpose_frame = CTK.CTkFrame(parent, fg_color="#1E1E1E", corner_radius=3, border_width=1, border_color="#9C27B0")
        # GIẢM PADDING
        transpose_frame.pack(fill="x", pady=1, padx=1)
        ...
        self.btn_pitch_old.pack(side="left", padx=1)
        ...
        self.btn_pitch_normal.pack(side="left", padx=1)
        ...
        self.btn_pitch_young.pack(side="left", padx=1)
